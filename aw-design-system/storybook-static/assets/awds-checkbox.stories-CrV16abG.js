import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{B as n,z as r}from"./iframe-D7r0Uamx.js";var i=t({Checked:()=>s,Default:()=>o,Disabled:()=>c,WithSlotLabel:()=>l,__namedExportsOrder:()=>u,default:()=>a}),a,o,s,c,l,u,d=e((()=>{r(),a={title:`AWDS/Checkbox`,component:`awds-checkbox`,argTypes:{label:{control:`text`},checked:{control:`boolean`},disabled:{control:`boolean`}}},o={args:{label:`I agree to the terms`,checked:!1,disabled:!1},render:e=>n` <awds-checkbox label=${e.label} ?checked=${e.checked} ?disabled=${e.disabled}></awds-checkbox> `},s={render:()=>n` <awds-checkbox checked label="Checked option"></awds-checkbox> `},c={render:()=>n`
